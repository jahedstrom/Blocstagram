...
// Override getter for lazy initialization
- (CAShapeLayer *)circleLayer {
    if(!_circleLayer) {
        CGPoint arcCenter = CGPointMake(self.radius+self.strokeThickness/2+5, self.radius+self.strokeThickness/2+5); // don't fully understand why /2 + 5
        CGRect rect = CGRectMake(0, 0, arcCenter.x*2, arcCenter.y*2);  // then we make a rectangle twice as big anyway..
        ...
        _circleLayer = [CAShapeLayer layer];  // acessing ivar directly because of lazy initialization
