...
- (void)shareMediaItems:(NSArray *)itemsToShare {
    if (itemsToShare.count > 0) {
        ...
        [self presentViewController:activityVC animated:YES completion:nil]; // maybe change this to self.navigationController then could call this
                                                                             // method from MediaFullScreenViewController.m?
    }
}
